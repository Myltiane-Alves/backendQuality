...
export const getPrimeiraVendaSaldoAtual = async (idEmpresa, dataPesquisa) => {
    try {
        ...
        const query1 = `
           	SELECT TO_VARCHAR(MIN(VENDA.DTHORAFECHAMENTO),'DD-MM-YYYY') AS DTPRIMEIRAVENDAFORMATADA,
        ...
        const query2 = `
            SELECT IFNULL(SUM(VRDESPESA), 0) AS VALORTOTALDESPESA,
        ...
        return {
            ...
            VALORCREDITO: saldoPositivo,
            VALORDEBITO: saldoNegativo,
            SALDO: saldoAtualizadoAtual,
            TOTALQUEBRA: totalQuebra,
            dataPrimeiraVenda,
            dataPesquisaFim
        };
