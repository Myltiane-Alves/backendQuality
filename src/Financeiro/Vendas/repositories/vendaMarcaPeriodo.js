...
export const getVendaMarcaPeriodo = async (idMarca, dataPesquisaInicio, dataPesquisaFim, idEmpresa, page, pageSize) => {
    try {
        ...
        throw new Error(`Erro ao executar a consulta Vendas por Marca: `, error);
    }
};
