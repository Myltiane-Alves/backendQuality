...
import { getTotaisVenda, getVendasLojaPeriodo } from "../repositories/vendaLojaPeriodo.js";
...
import { getVendaTotalMes } from "../repositories/vendaTotalMes.js";
import { getVendaTotalLojaHora } from "../repositories/vendaTotalLojaHora.js";
import { getVendaTotalTO } from "../repositories/vendaTotalTO.js";
...
class FinanceiroVendasControllers {
  ...
  async getListaVendasLojaPeriodo(req, res) {
    try {
      ...
      const result = await getVendasLojaPeriodo(idEmpresa, dataPesquisaInicio, dataPesquisaFim, page, pageSize);
  ...
  async getListaVendasDigital(req, res) {
    ...
    try {
      let { idVenda, idEmpresa, dataPesquisaInicio, dataPesquisaFim, page, pageSize } = req.query;
      ...
      page = page ? page : '';
      pageSize = pageSize ? pageSize : '';
      const response = await getVendaDigital(idVenda, idEmpresa, dataPesquisaInicio, dataPesquisaFim, page, pageSize);
  ...
  async getListaVendasDigitalMarca(req, res) {
    ...
    if (dataPesquisaInicio && dataPesquisaFim) {
      ...
      try {
        ...
        console.error("Erro no controller Financeiro Vendas getListaVendasDigitalMarca", error);
        throw error;
      }
    } else {
      console.error("Erro no controller Financeiro Vendas getListaVendasDigitalMarca: dataPesquisaInicio e dataPesquisaFim são obrigatórios");
      return res.status(400).json({ message: "dataPesquisaInicio e dataPesquisaFim são obrigatórios" });
    }
  }
  ...
  async getListaVendasConciliar(req, res) {
    ...
    try {
      ...
      console.error("Erro no FinanceiroVendasControllers getListaVendasConciliar", error);
      throw error;
    }
    } else {
      console.error("Erro no FinanceiroVendasControllers getListaVendasConciliar DataPesquisa é obrigatório")
    }
  ...
  async getListaVendasTotal(req, res) {
    ...
    if(dataPesquisa != '') {
      ...
      try {
        ...
        console.error("erro no controller Financeiro Vendas getListaVendasTotal", error);
        throw error;
      }

    } else {
      console.error("DataPesquisa não pode ser vazia");
    }
  ...
  async getListaRemessaVendas(req, res) {
    ...
    try {
      ...
      console.error("erro no controller Financeiro Vendas getListaRemessaVendas", error);
      throw error;
    }
  ...
  async getListaRecebimentosEletronico(req, res) {
    ...
    try {
      ...
      console.error("Eerro no controller Financeiro Vendas getListaRecebimentosEletronico", error);
      throw error;
    }
  ...
  async getListaRecebimentos(req, res) {
    ...
    try {
      ...
      console.error("Eerro no controller Financeiro Vendas getListaRecebimentos", error);
      throw error;
    }
  }

  async getListaVendasMarca(req, res) {
    let { idMarca, dataPesquisaInicio, dataPesquisaFim, idEmpresa, idLojaPesquisa, page, pageSize } = req.query;
    ...
    try {
      ...
      // const response = await axios.get(apiUrl)
      const response = await getVendaMarcaPeriodo(idMarca, dataPesquisaInicio, dataPesquisaFim, idEmpresa, idLojaPesquisa, page, pageSize)
