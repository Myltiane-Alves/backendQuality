...
export const getSubMenuUsuario = async (idSubMenus, idMenu, idPerfil, idModulo, dsModulo) => {
    try {
        ...
        let query = `
           SELECT 
            ...
            INNER JOIN 
                "${databaseSchema}".MENUFILHO AS Mn ON Men.IDMENU = Mn.IDMENUPAI
            WHERE 
                1 = 1
        `;
