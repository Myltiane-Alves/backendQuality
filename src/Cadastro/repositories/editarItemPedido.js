...
export const getItemPedido = async (idPedido, idDetalhePedido, dataPesquisaInicio, dataPesquisaFim, stTransformado, page, pageSize) => {
    try {
        ...
        console.error('Erro ao consultar Itens de Detalhe Pedidos :', error);
        throw error;
    }
}